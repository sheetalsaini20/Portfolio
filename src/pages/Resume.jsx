        ...
        <div className="resume_sec py-90" id={id}>
            ...
            <div class="resume-timeline">
                ...
                <div class="item scroll-animation" data-aos="fade-left">
                    <span class="data-time grey-txt  mb-3">(2022-2025)- 68%</span>
                ...
                <div class="item scroll-animation " data-aos="fade-down-left">
                    ...
                    <h3>Multimedia Executive (UI/UX & Frontend Developer)</h3>
                    <p className='grey-txt fs-2 mb-0'>Virtual Employee Private Limited</p>
                    <p className='grey-txt fs-4 fst-italic'>Remote </p>
            ...
            <div className="down-btn mt-5">
                <a href={docUrl + "Sheetal_Kapoor_Resume.pdf"} download className="theme-btn btn">
                    Download Resume</a>
            </div>
        </div >
    );
